...
- [feat(xsai): support `fullStream`](https://github.com/VoltAgent/voltagent/pull/443) on [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) (2 days ago)
- [fix(xsschema): fix strict json schema in nested object](https://github.com/moeru-ai/xsai/pull/203) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (2 days ago)
- [chore(deps): bump xsai, std](https://github.com/moeru-ai/airi/pull/338) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (2 days ago)
- [refactor(stage-web): remove chat tabs](https://github.com/moeru-ai/airi/pull/331) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (4 days ago)
- [chore: fix test](https://github.com/moeru-ai/xsai/pull/199) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (1 week ago)
