...
- [fix(memu-js): add wantSummary to retrieveDefaultCategories options](https://github.com/NevaMind-AI/memU/pull/22) on [NevaMind-AI/memU](https://github.com/NevaMind-AI/memU) (2 days ago)
- [fix(memu-js): use globalThis.process instead of process](https://github.com/NevaMind-AI/memU/pull/20) on [NevaMind-AI/memU](https://github.com/NevaMind-AI/memU) (2 days ago)
- [feat(app): memory](https://github.com/moeru-ai/chat/pull/11) on [moeru-ai/chat](https://github.com/moeru-ai/chat) (2 days ago)
- [refactor: avoid catch twice](https://github.com/moeru-ai/xsai/pull/209) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (4 days ago)
