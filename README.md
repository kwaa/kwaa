...
- [feat(generate-object,stream-object): add strict option](https://github.com/moeru-ai/xsai/pull/205) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (3 days ago)
- [feat(tool): add strict option](https://github.com/moeru-ai/xsai/pull/204) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (3 days ago)
- [feat(xsai): support `fullStream`](https://github.com/VoltAgent/voltagent/pull/443) on [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) (5 days ago)
- [fix(xsschema): fix strict json schema in nested object](https://github.com/moeru-ai/xsai/pull/203) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (5 days ago)
- [chore(deps): bump xsai, std](https://github.com/moeru-ai/airi/pull/338) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (5 days ago)
