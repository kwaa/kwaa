...
- [moeru-ai/cosine-similarity](https://github.com/moeru-ai/cosine-similarity) - 🆚 Measures the similarity between two non-zero vectors, fast and small. (2 days ago)
...
- [feat: new package `generate-image`](https://github.com/moeru-ai/xsai/pull/123) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (today)
- [feat: prefer publish config when defined](https://github.com/privatenumber/pkgroll/pull/120) on [privatenumber/pkgroll](https://github.com/privatenumber/pkgroll) (1 day ago)
- [feat(tool): returns schema](https://github.com/moeru-ai/xsai/pull/118) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (3 days ago)
- [chore(twitter-services): remove preinstall](https://github.com/moeru-ai/airi/pull/93) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (3 days ago)
- [chore(docs): remove ico from head, remove houston](https://github.com/moeru-ai/airi/pull/92) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (3 days ago)
