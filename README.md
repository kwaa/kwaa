...
- [refactor(generate-text): trampoline function](https://github.com/moeru-ai/xsai/pull/25) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (2 days ago)
- [chore(providers/google-generative-ai): update model list](https://github.com/moeru-ai/xsai/pull/21) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (4 days ago)
- [chore: bump xsai, update speech params](https://github.com/moeru-ai/airi/pull/12) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (5 days ago)
- [refactor(providers)!: improve structure](https://github.com/moeru-ai/xsai/pull/19) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (5 days ago)
- [feat: new package `stream-object`](https://github.com/moeru-ai/xsai/pull/18) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (6 days ago)
