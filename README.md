...
- [fix(xsai): bump to v0.4.0-beta.1, support file &amp; reasoning](https://github.com/VoltAgent/voltagent/pull/494) on [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) (4 days ago)
- [refactor(shared-chat)!: rewrite types to align with openai](https://github.com/moeru-ai/xsai/pull/207) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (5 days ago)
