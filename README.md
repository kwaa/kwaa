...
- [err-require-esm/unplugin-require-esm](https://github.com/err-require-esm/unplugin-require-esm) - An interesting Unplugin that does its best to make your code run only in an ES Modules. [WIP] (1 day ago)
...
- [update urara stars](https://github.com/svelte-society/sveltesociety.dev/pull/418) on [svelte-society/sveltesociety.dev](https://github.com/svelte-society/sveltesociety.dev) (1 day ago)
