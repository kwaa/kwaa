...
- [importantimport/package-json](https://github.com/importantimport/package-json) - {...} Command-line tools and libraries for package.json. (3 weeks ago)
...
- [refactor: event segmentation v2.1](https://github.com/moeru-ai/plast-mem/pull/63) on [moeru-ai/plast-mem](https://github.com/moeru-ai/plast-mem) (3 days ago)
- [refactor(locomo): adjust prompt](https://github.com/moeru-ai/plast-mem/pull/61) on [moeru-ai/plast-mem](https://github.com/moeru-ai/plast-mem) (4 days ago)
- [refactor!: event segmentation v2](https://github.com/moeru-ai/plast-mem/pull/60) on [moeru-ai/plast-mem](https://github.com/moeru-ai/plast-mem) (5 days ago)
- [refactor: add longmemeval bench](https://github.com/moeru-ai/plast-mem/pull/59) on [moeru-ai/plast-mem](https://github.com/moeru-ai/plast-mem) (6 days ago)
- [refactor(locomo): merge scoring step](https://github.com/moeru-ai/plast-mem/pull/58) on [moeru-ai/plast-mem](https://github.com/moeru-ai/plast-mem) (1 week ago)
