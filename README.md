...
- [feat(xsai): support `fullStream`](https://github.com/VoltAgent/voltagent/pull/443) on [VoltAgent/voltagent](https://github.com/VoltAgent/voltagent) (1 day ago)
- [fix(xsschema): fix strict json schema in nested object](https://github.com/moeru-ai/xsai/pull/203) on [moeru-ai/xsai](https://github.com/moeru-ai/xsai) (1 day ago)
- [chore(deps): bump xsai, std](https://github.com/moeru-ai/airi/pull/338) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (1 day ago)
- [refactor(stage-web): remove chat tabs](https://github.com/moeru-ai/airi/pull/331) on [moeru-ai/airi](https://github.com/moeru-ai/airi) (3 days ago)
